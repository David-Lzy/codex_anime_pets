...
Original 5-head research assistant with chestnut hair, skeptical eyes, casual jacket and state-dependent lab coat. Codex v2/v1 and HD desktop animation.

原创约5头身研究助理，栗色长发、冷静眼神，按动作切换日常短外套与白大褂。支持 Codex v2/v1 和独立高清桌宠。
...
```sh
python scripts/install.py --pet assistant-004-anime
```
